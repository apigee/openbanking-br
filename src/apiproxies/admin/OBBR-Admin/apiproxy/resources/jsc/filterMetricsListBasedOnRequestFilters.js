...
function removeMetrics(metricsObject,periodFilter) {
    ...
    // The availability metric structure in Open Banking BR currently has no current or historic information.
    // This logic is not needed, but the structure might be changed to include current and historic information. 
    ...
    const elementToKeep = (periodFilter == "CURRENT") ? "currentDay" : "previousDays";
    
    // Process all simple structure metrics
    listOfMetricsToProcess = ["averageTps","peakTps","errors","rejections"];
    ...
    listOfPerformanceTiers = ["unauthenticated","highPriority","mediumPriority","unattended"];
